...
HD_PWD='C:/Users/robdj/Desktop/hdmi_pass_through_ZyboZ7-10-master/dvipass/dvipass.runs/dvi2rgb_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dvi2rgb_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dvi2rgb_1.tcl
