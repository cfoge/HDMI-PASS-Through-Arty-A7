...
HD_PWD='C:/Users/robdj/Documents/RMIT_2021/CAP_STONE/DVI_PASSTHROUGH_CAPS/Working_HDMI_passthrough/Working_HDMI_passthrough.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dvi_pass_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dvi_pass_top.tcl -notrace
