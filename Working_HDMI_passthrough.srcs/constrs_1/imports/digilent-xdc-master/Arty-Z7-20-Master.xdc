...
create_clock -period 8.000 -name sys_clk_pin -waveform {0.000 4.000} -add [get_ports sysclk_i]
 #contrain clock to 720p
#create_clock -period 13.468 -waveform {0.000 5.000} [get_ports hdmi_rx_clk_p]
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets DVI_IN_OUT_i/rgb2dvi_0/U0/ClockGenInternal.ClockGenX/PixelClkInX5]
## Switches
