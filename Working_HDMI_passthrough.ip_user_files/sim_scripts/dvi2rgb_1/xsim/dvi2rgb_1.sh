...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dvi2rgb_1 xil_defaultlib.dvi2rgb_1 xil_defaultlib.glbl -log elaborate.log
}
